...
export const people = [
	...
	},
	{
		...
		linkedinUrl: '#',
		instagramUrl:
			'https://www.instagram.com/invites/contact/?i=w2driehj59m3&utm_content=1vmto5l',
	...
	},
	{
		...
		linkedinUrl:
			'https://www.linkedin.com/in/nawaf-m-alakel-b6823a219/ar?trk=people-guest_people_search-card&originalSubdomain=sa',
	...
	},
	{
		...
		twitterUrl: '#',
		linkedinUrl: '#',
		instagramUrl: 'https://instagram.com/iwannanery',
		...
		<div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
			...
			<div className="mt-8 md:mt-0 md:order-1">
				<p className="text-center text-xl text-gray-400">
					&copy; 2023, Erfad Org. All rights reserved.
				</p>
			</div>
		</div>
	</footer>
          ...
          <div className="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
						...
						<div className="text-center">
							...
							<div className="flex justify-between flex-wrap-reverse gap-10">
								<p className="w-[400px] text-right mt-3 max-w-md mx-auto text-2xl text-gray-500 md:mt-5 md:max-w-3xl">
									منظمة بيئية غير ربحية يديرها مجموعة من الشباب المؤيدين للثقافة
									البيئية، سعيَا منهم لزيادة الوعي عن القضايا البيئية، والعمل
									على خطط مدروسة تحدث تغيير على أرض الواقع.
								</p>
							</div>
                ...
                >
                  Our Blog
								...
								<div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
									<a
										href="https://erfad-ar.blogspot.com/"
										target="_blank"
										rel="noreferrer"
					...
					<div className="grid grid-cols-1 gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8">
						<div className="bg-white rounded-2xl shadow-xl">
							<div className="flex-1 relative pt-16 px-6 pb-8 md:px-8">
								...
								<p className="mt-4 text-xl text-gray-500 text-right">
									سعودية أكثر اخضرارَا, يسهم مواطنوها مجتمعين على اتباع ممارسات
									يومية تساعد في تحسين البيئة.
								</p>
							</div>
						</div>
						<div className="bg-white rounded-2xl shadow-xl">
							<div className="flex-1 relative pt-16 px-6 pb-8 md:px-8">
								...
								<p className="mt-4 text-xl text-gray-500 text-right">
									نسعى إلى بناء مجتمع يؤثر على البيئة بشكل إيجابي من خلال رفع
									الوعي لديهم، وإتاحة حملات وفرص تطوعية ثريّة توطّد القيم
									البيئية.
								</p>
							</div>
						</div>
						<div className="bg-white rounded-2xl shadow-xl">
							<div className="flex-1 relative pt-16 px-6 pb-8 md:px-8">
								...
								<ul className="list-disc list-inside mt-4 text-xl text-gray-500 [direction:rtl]">
									<li>
										الدعوة إلى اتخاذ إجراءات عاجلة بشأن القضايا البيئية بشكل عام
										وقضية التغير المناخي بشكل خاص في المجتمع السعودي.
									</li>
									<li>تصحيح المفاهيم الخاطئة المتعلقة بالبيئة.</li>
									<li>
										تعزيز الثقافة البيئية عن طريق صنع محتوى ملائم لجميع فئات
										المجتمع السعودي بحيث يحقق هدف المنظمة الرئيسي.
									</li>
									<li>
										الحث على إحداث فارق وإيجاد حلول تساعد في تحسين البيئة.
									</li>
									<li>
										خلق فرص لجميع فئات المجتمع السعودي والبدء باتخاذ إجراءات
										حقيقية لتحسين البيئة.
									</li>
								</ul>
							</div>
						</div>
			...
			<div className="bg-white">
				<div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
					<div>
						<p className="mt-2 text-3xl font-extrabold text-gray-900 text-right">
							قيمنا
						</p>
					</div>
							...
							<div className="relative">
								<dt>
									<CheckIcon
										...
										aria-hidden="true"
									/>
									<p className="ml-9 text-2xl leading-6 font-medium text-gray-900">
										الإصرار
									</p>
								</dt>
							</div>
						...
						<dl className="mt-10 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-8 sm:gap-y-10 lg:mt-0 lg:col-span-2">
							<div className="[direction:rtl]">
								...
								<dd className="mt-2 text-xl text-gray-500">
									إرفاد مرادف إحسان، والتي تمثل احدى اهدافنا التي نسعى لها في كل
									عمل يحمل اسم المنظمة.
								</dd>
							</div>
						</dl>
					</div>
								...
								{people.slice(0, 3).map((person) => (
									<li key={person.name}>
										<div className="flex items-center space-x-4 lg:space-x-6">
											{person.imageUrl === '#' ? (
												<UserCircleIcon className="w-16 h-16 rounded-full lg:w-20 lg:h-20 stroke-gray-300" />
											) : (
												<img
