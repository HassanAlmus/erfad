...
import { StarIcon, SparklesIcon, CheckIcon, InformationCircleIcon, QuestionMarkCircleIcon, AtSymbolIcon, UserCircleIcon} from '@heroicons/react/outline'
                ...
                <div className="flex flex-col justify-between space-y-6 h-full bg-gray-800 py-10 px-6 rounded-lg xl:px-10">
                  ...
                  <ul role="list" className="flex justify-center space-x-5">
                      ...
                      {person.instagramUrl!=='#'&&<li>
                        <a target='_blank' href={person.instagramUrl} className="text-gray-400 hover:text-gray-500">
                      ...
                      <li>
                        <a target='_blank' href={`mailto:${person.email}`} className="text-gray-400 hover:text-gray-500">
