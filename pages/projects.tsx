    ...
    <>
            ...
            <nav className="relative flex items-center justify-between sm:h-10 md:justify-center" aria-label="Global">
                <div className="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
                    <div className="flex items-center justify-between w-full md:w-auto">
                        ...
                        <Link href={'/'}>
                            <img className="h-8 w-auto sm:h-10 cursor-pointer" src="https://cdn.discordapp.com/attachments/852672256977928224/979399215769845890/46E4B8A6-ACF3-48B9-9622-F9F6B693DC7B__1_-removebg-preview.png" alt=""/>
                        </Link>
                    </div>
                </div>
            </nav>
                ...
                <div className="relative sm:py-16 lg:py-0">
                    ...
                    <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
                        ...
                        <div className="relative pt-64 pb-10 rounded-2xl shadow-xl overflow-hidden">
                            <img className="absolute inset-0 h-full w-full object-cover" src="https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt=""/>
                            ...
                            <div className="relative px-8">
                                <blockquote className="mt-8 [direction:rtl]">
                                    <div className="relative text-lg font-medium text-white md:flex-grow">
                                        <svg className="absolute top-0 right-0 transform -translate-x-3 -translate-y-2 h-8 w-8 text-rose-400" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
        ...
        <div className="bg-white">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                <div className="mt-6 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-8">
                    ...
                    <div className="col-span-1 flex flex-col items-center py-8 px-8 bg-gray-50">
                        <img className="max-h-12" src="/botanical.png" alt="Botanical"/>
                        <h3 className='mt-5'>Batonical Gardens</h3>
                    </div>
                    <div className="col-span-1 flex flex-col items-center py-8 px-8 bg-gray-50">
                        <img className="max-h-12" src="/medizine.png" alt="Medizine"/>
                        <h3 className='mt-5'>MediZine | مديزين</h3>
                    </div>
                    <div className="col-span-1 flex flex-col items-center py-8 px-8 bg-gray-50">
                        <img className="max-h-12" src="/viola.png" alt="Viola"/>
        ...
        <div className='flex flex-wrap items-center'
            ...
            <div className='flex flex-wrap'
                ...
                <div style={
                    ...
                    <Image src="/greentalk.png" alt="شعار حوار اخضر" layout="fill" objectFit="contain"/>
                </div>
                <div style={
                    {
                        position: "relative",
                    ...
                    <Image src="/evc.png" alt="فريق عفت التطوعي" layout="fill" objectFit="contain"/>
                </div>
            </div>
        ...
        <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
            ...
            <div className="pt-12 sm:pt-16 lg:pt-20">
                ...
                <div className="mt-6 text-gray-500 space-y-6">
                    <p className="text-xl text-right">
                        تم إنشاء مدونة يتناول فيها كتّاب إرفاد مقالات شهرية تناقش القضايا البيئية وملامستها للواقع، والطرق الممكنة لحلها على الصعيد الشخصي والمجتمعي والعالمي.
